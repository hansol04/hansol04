...
React 기반의 UI 구현 경험을 바탕으로, 풀스택 개발자로의 확장을 목표로 학습하고 있습니다.

문해력 향상 웹 서비스, 여행 일정 추천 플랫폼, 오프라인 채팅 앱 등 다양한 프로젝트를 통해
사용자 중심의 UI/UX 구현, 컴포넌트 설계, 상태 관리, API 연동 등 프론트엔드 실무 역량을 쌓았고,
현재는 Java와 Spring Boot 기반 백엔드 개발 학습을 병행하며
서비스 전체 흐름을 이해하고 구현할 수 있는 개발자로 성장 중입니다.
